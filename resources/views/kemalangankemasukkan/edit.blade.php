...
@section('content')
      ...
      <div class="col-md-10" style="margin-left: 7%; margin-top:2%">
        ...
        {!! Form::open(['action' => ['KemalanganKemasukkanController@update',$kemalangan->id], 'method'=>'POST']) !!}
        <div class="card-body">
            ...
            <div class="form-group">
                ...
                {{Form::text('nama_balai',$kemalangan->nama_balai,['class'=>'form-control'])}}
            </div>
            ...
            <div class="form-group">
                ...
                {{Form::text('status',$kemalangan->status,['class'=>'form-control'])}}
            </div>
            ...
            <div class="form-group">
                ...
                {{Form::text('lokasi',$kemalangan->lokasi,['class'=>'form-control'])}}
            </div>
            ...
            <div class="form-group">
                ...
                {{Form::text('nama_mangsa',$kemalangan->nama_mangsa,['class'=>'form-control'])}}
            </div>

            <div class="form-group">
                {{Form::label('ic','No Kad Pengenalan')}}
                {{Form::text('ic',$kemalangan->ic,['class'=>'form-control'])}}
            </div>

            <div class="form-group">
                {{Form::label('gambar','Gambar')}}
                {{Form::text('gambar',$kemalangan->gambar,['class'=>'form-control'])}}
            </div>

            <div class="form-group">
                {{Form::label('bangsa','Bangsa')}}
                {{Form::text('bangsa',$kemalangan->bangsa,['class'=>'form-control'])}}
            </div>

            <div class="form-group">
                {{Form::label('jantina','Jantina')}}
                {{Form::text('jantina',$kemalangan->jantina,['class'=>'form-control'])}}
            </div>

            <div class="form-group">
                {{Form::label('alamat','Alamat')}}
                {{Form::text('alamat',$kemalangan->alamat,['class'=>'form-control'])}}
            </div>

            <div class="form-group">
              
                {{Form::text('pengesahan',$kemalangan->pengesahan,['class'=>'form-control' ,'hidden'])}}
            </div>
