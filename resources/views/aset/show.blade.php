      ...
      <div class="col-md-10" style="margin-left: 7%; margin-top:2%">
        ...
        <div class="card" style="background-color:white">
          <div class="card-header" style="background-color:#c11a1a">
            <h3 class="card-title" style="color:white">Urus Aset & Kelengkapan</h3>
          </div>
          ...
          <form role="form" method="POST" action="{{action('AsetController@store')}}">
            ...
            <tr>
            <td width="100px">Kod Aset<font color="red">*</font></td>
            <td width="10px">:</td>
            <td width="650px"> <input type="text" class="form-control" name="kod"/></td>
            </tr>

            <tr>
            <td width="100px">Nama Aset<font color="red">*</font></td>
            <td width="10px">:</td>
            ...
            <br><center> <input type="submit" name="submit" class="btn btn-small" style="background-color:white; border:1px solid #555555"  value="Tambah"/>
        ...
        <table class="table table-bordered">
              ...
              <tbody>
                ...
                <tr>
                    <td><a href="/aset/{{$aset->id}}/edit" class= "btn btn-small" style="background-color:#c11a1a"><i class="fa fa-edit" style="color:white"></i></a></td>
                    <td>{{$aset->kod}}</td>
                    <td>{{$aset->nama}}</td>
                    <td>{{$aset->name}}</td>
