      ...
      <div class="col-md-11" style="margin-left: 7%; margin-top:2%">
        ...
        <div class="card card-primary">
          <div class="card-header">
            <h3 class="card-title">Pengesahan Menyelamat</h3>
          </div>
          <!-- /.card-header -->
          <!-- form start -->
          <table class="table table-bordered">
                        ...
                        <tbody>
                         @foreach($menyelamats as $menyelamat)
                          <tr>
                              <td><a href="/menyelamatpengesahan/{{$menyelamat->id}}/edit" class= "btn btn-small bg-gradient-primary"><i class="fa fa-edit"></i></a></td>
